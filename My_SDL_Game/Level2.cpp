...
Level2::Level2(DungeonCrawlerGame* pOwner, PlayerCharacter* pPlayer, CollisionManager* pCollisionManager,
	TTF_Font* pFont)
	:m_pOwner(pOwner)
	, mpPlayer(pPlayer)
...
void Level2::Enter()
{
	...
	{
		// Map
		mGameObjects.push_back(new TileMap(this, mpCollisionManager, "assets/Levels/Room2.txt"));
...
void Level2::Update(double deltaTime)
{
	...
	{
		m_pOwner->LoadScene(DungeonCrawlerGame::Room3Screen);
	}
...
bool Level2::HandleEvent(SDL_Event* pEvent)
{
